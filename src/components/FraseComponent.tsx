...
const FraseComponent = (props: Props) => {
  return (
    <div className="bg-amber-300 w-screen py-6 px-20 object-cover ">
      ...
      <p className={`' before:content-["“"] before:text-white before:mr-2 before:font-bold before:text-xl after:content-["”"] after:font-bold after:text-xl after:text-white after:ml-2  py-12 text-black font-light text-justify leading-6' ${roboto.className}`}>
