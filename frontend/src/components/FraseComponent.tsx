...
const FraseComponent = () => {
  Animations()
  return (
    <div className="bg-[var(--primary-color)] w-screen py-6 px-20 object-cover " data-aos="fade-up" data-aos-duration="500" >
      <div className="flex flex-col max-w-[60rem] mx-auto gap-4 items-center indent-4">

      <p className={`' before:content-["“"] before:text-white before:mr-2 before:font-bold before:text-xl after:content-["”"] after:font-bold after:text-xl after:text-white after:ml-2  py-12 text-white font-light text-justify leading-6' ${robotoItalic.className}`}>
